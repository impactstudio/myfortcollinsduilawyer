...
CaseResult.create(result: "Our customer was accused of four lawful offense count: (1) Theft, (2) Identity Theft, (3) Forgery, and (4) Commercial Bribery, and if convicted was confronting over 20 years in jail. We held the forensic report inspector and a private investigator. In the wake of meeting with us to survey the conclusion of the master and the investigative reports, the District Attorney consented to reject the majority of the charges.")
CaseResult.create(result: "Three Counts of Theft and Three Counts of Identity Theft both Felony Charges. The client we were representing was facing 32 years. After an in-depth investigation and many meetings with the District Attorney, we negotiated a plea that resulted in no jail, and only one year of probationary supervision.")
CaseResult.create(result: "Domestic Violence Charge. After providing an in-depth investigation and detailed analysis domestic violence laws, our firm was able to persuade the District Attorney to dismiss all charges.")
...
CaseResult.create(result: "Obstructing a Peace Officer and Resisting Arrest. Case dismissed with the District Attorney after a cautious review of the video tape that was in evidence.")
...
CaseResult.create(result: "Felony Possession of Illegal Drugs. Our client entered a plea of guilty to possession of paraphernalia, a petty offense.")
CaseResult.create(result: "Felony Criminal Mischief. After reviewing several video tapes and other evidence in this case, we were able to convince the District Attorney to dismiss the case.")
...
CaseResult.create(result: "Third Degree Assault. With our help, our client was able to persuade the District Attorney to drop the case before the trial.")
...
CaseResult.create(result: "Domestic Violence - Criminal Mischief - Felony Burglary. After several meetings, our firm was able to persuade the district Attorney to drop the case.")
...
CaseResult.create(result: "Domestic Violence - Third Degree Assault. Our firm represented a client prefiling, and in time convinced the District Attorney to not file criminal charges.")
...
CaseResult.create(result: "Domestic - Harassment - Violence Assault in the Third Degree. Our firm was able to convince a District Attorney that the client was acting in their self defense. The District Attorney finally agreed to drop the case before trial.")
